...
public class Main {
	...
	public static void main(String[] args) throws IOException {
			...
			public void run() {
				try {
					...
					while(!server.isClosed()) {
						...
						String html = "<html><body><img src=\"http://192.168.0.104:8080\" align=\"middle\" style=\"position: absolute; margin: auto; left: 0; right: 0; top: 0; bottom: 0;\"></body></html>";
		...
		ArrayBlockingQueue<Image> queue = new ArrayBlockingQueue<Image>(1);
		try {
